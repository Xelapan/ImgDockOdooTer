...
from odoo.addons.l10n_mx_edi_stock_extended_30.tests.common import TestMXDeliveryGuideCommon
...
class TestCFDIPickingXml(TestMXDeliveryGuideCommon):
    ...
    def _assert_document_cfdi(self, cfdi, filename):
        ...
        self.assertXmlTreeEqual(
            self.get_xml_tree_from_string(cfdi),
